...
import { X, CheckCircle2, Loader2, Calendar, PhoneCall, Mail, User, History, GitMerge, ShieldAlert, Edit2, Save } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
          <div>
            ...
            <p className="text-sm text-slate-500">Branch: <span className="font-semibold text-slate-700">{company.assignedBranch}</span></p>
          </div>
